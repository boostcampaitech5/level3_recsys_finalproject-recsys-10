...
pickle_path = '/opt/ml/Recipe_Project/Recipe_code/Ingredient_Based_RecSys'


# csv 파일들을 토대로 Recipe의 vector들을 만드는 함수. -> 프로그램 실행 시점에 한 번만 실행시켜두면 됨 -> 약 3분 소요
initialize_vector(ingresync_recipe_path, cate_recipe_path, pickle_path) 


save_pickle_path = '/opt/ml/Recipe_Project/Recipe_code/Ingredient_Based_RecSys/Ingredient_Recsys_pkl.pkl'
